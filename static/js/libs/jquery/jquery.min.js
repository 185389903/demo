...
},t,o?r:void 0,o,null)}})}),re.fn.size=function(){return this.length},re.fn.andSelf=re.fn.addBack,"function"==typeof define&&define.amd?define("jquery",[],function(){return re}):"function"!=typeof define||define.amd||define(function(){return re});var zt=e.jQuery,It=e.$;return re.noConflict=function(t){return e.$===re&&(e.$=It),t&&e.jQuery===re&&(e.jQuery=zt),re},typeof t===ve&&(e.jQuery=e.$=re),re});